...
class CartItem(models.Model):
	...
	def remove(self):
		return self.item.remove_form_cart()
...
class Cart(models.Model):
	...
	tax_percentage = models.DecimalField(max_digits=10, decimal_places=5, default=0.2)
	subtotal = models.DecimalField(max_digits=40, decimal_places=2, default=0.00)
	tax_total = models.DecimalField(max_digits=40, decimal_places=2, default=0.00)
